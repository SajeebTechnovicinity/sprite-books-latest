                        ...
                        <div class="block-component">
                            <div class="author-summary">
                                <div class="author-bio unit">
                                    ...
                                    <div class="author-email">
                                        <a href="{{$author[0]->author_website_bio}}" target="__blank" class="link"> {{$author[0]->author_website_bio}}</a>
                                    </div>
                                ...
                                <p class="credit__name">Location</p>
                                    ...
                                    {{-- <p class="credit__name">Reviews</p>
                                    <p class="creadit__no text-center">
                                        100,103
                                    </p> --}}
                                    <p class="credit__name">Following</p>
                                    <p class="creadit__no text-center">
                                        {{count($user_following)}}
                                    </p>
                                    {{-- <p class="credit__name">Events</p>
                                    <p class="creadit__no text-center">3</p> --}}
                                </div>
                            ...
                            <div class="tabs-wrap space-0">
                                <div class="tabs-btns-row">
                                    ...
                                    <a href="#followers" class="tab-btn">Following</a>
                                    {{-- <a href="#reviews" class="tab-btn">Reviews</a> --}}
                                </div>
                                <div class="tab-body">
                                    <div class="tab-body__inner books" id="books">
                                        <div class="grid-container">
                                            @foreach ($user_following as $rowFollowing)


                                            <div class="follower-card flex-wrap">
                                                <figure class="figure">
                                                    <img src="{{asset($rowFollowing->Author->author_profile_picture)}}" alt="" />
                                                </figure>
                                                <div class="follower-data">
                                                    <h3 class="name">
                                                        {{$rowFollowing->Author->author_name}}
                                                    </h3>
                                                            ...
                                                            <span class="icon">
                                                                <svg width="12" height="12" viewBox="0 0 12 12"
                                                                    ...
                                                                    <path
                                                                        ...
                                                                        fill="#3E3E3E" />
                                                                </svg> </span>{{get_author_total_followers_count_by_author_id($rowFollowing->Author->id)}} Followers
                                                        </p>
                                                    </div>
                                                    <div class="follower-data__row flex-wrap">
                                                        <p class="text">
                                                            <span class="icon">
                                                                <svg width="12" height="17" viewBox="0 0 12 17"
                                                                    ...
                                                                    <path
                                                                        d="M6 0C4.4087 0 2.88258 0.656632 1.75736 1.82544C0.632141 2.99426 0 4.57951 0 6.23246C0 9.52433 5.34545 16.4877 5.57455 16.788C5.62566 16.8541 5.69042 16.9076 5.76406 16.9443C5.83769 16.9809 5.91833 17 6 17C6.08167 17 6.1623 16.9809 6.23594 16.9443C6.30958 16.9076 6.37434 16.8541 6.42545 16.788C6.65455 16.4877 12 9.52433 12 6.23246C12 4.57951 11.3679 2.99426 10.2426 1.82544C9.11742 0.656632 7.5913 0 6 0ZM6 7.93222C5.56848 7.93222 5.14665 7.7993 4.78785 7.55027C4.42905 7.30124 4.1494 6.94728 3.98426 6.53316C3.81913 6.11904 3.77592 5.66336 3.8601 5.22373C3.94429 4.7841 4.15209 4.38027 4.45722 4.06332C4.76235 3.74637 5.15112 3.53052 5.57435 3.44307C5.99758 3.35562 6.43627 3.4005 6.83495 3.57204C7.23362 3.74357 7.57437 4.03406 7.81412 4.40675C8.05386 4.77945 8.18182 5.21763 8.18182 5.66587C8.18182 6.26694 7.95195 6.8434 7.54278 7.26842C7.13361 7.69344 6.57865 7.93222 6 7.93222Z"
                                                                        fill="black" />
                                                                </svg> </span>  {{$rowFollowing->Author->author_country}}
                                                        </p>
                                                        {{-- <p class="text">
                                                            <span class="icon">
                                                ...
                                                <div class="btn-group">
                                                    @if( $rowFollowing->Author->id == session('author_id'))
                                            <a href="#." class="link btn-lite" onclick="alert('You can not unfollow yourself !')">Unfollow</a>
                                            @else

                                                    <a href="#" class="btn-lite btn UnfollowAuthorNow" id="followingAuthor{{$rowFollowing->user_id}}_{{$rowFollowing->Author->id}}" onclick="UnfollowAuthorNow({{$rowFollowing->user_id}},{{$rowFollowing->Author->id}})">
                                                        <span class="icon">
                                                    ...
                                                    @endif
                                                    <a href="{{url('author-details/'.$rowFollowing->Author->id)}}" class="btn-solid btn">
                                                        View Profile
                                                    </a>
                                                </div>
                                            </div>
                                    ...
                                    {{-- <div class="tab-body__inner d-none" id="events">
                                        <div class="event-card">
                                            <figure class="figure">
                                                <img src="{{asset('public/frontend_asset')}}/imgs/man.png" alt="" />
                                            </figure>
                                            <div class="content">
                                                ...
                                                <p class="event-card__timezone flex-wrap">
                                                    January 15-20, 2020<span class="center">10:00 AM-4:00PM
                                                        PST</span><span>Manila,
                                                        Philippines</span>
                                                </p>
                                                <p class="para">
                                    ...
                                    <div class="tab-body__inner author-media d-none" id="media">
                                        ...
                                        <div class="media-wrap space-bottom">
                                            <figure class="media-item image">
                                                <img src="{{asset('public/frontend_asset')}}/imgs/placeholder-10.png" alt="" />
                                            </figure>
                                            <a href="#" class="media-item video">
                                                <img src="{{asset('public/frontend_asset')}}/imgs/placeholder-17.png" alt="" />
                                                <span class="icon">
                                            ...
                                            <a href="#" class="media-item video">
                                                <img src="{{asset('public/frontend_asset')}}/imgs/placeholder-15.png" alt="" />
                                                <span class="icon">
                                                    <svg width="58" height="58" viewBox="0 0 58 58"
                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        <circle cx="29" cy="29" r="28.5"
                                            ...
                                            <figure class="media-item image">
                                                <img src="{{asset('public/frontend_asset')}}/imgs/placeholder-16.png" alt="" />
                                            </figure>
                                            <a href="#" class="media-item video">
                                                <img src="{{asset('public/frontend_asset')}}/imgs/placeholder-15.png" alt="" />
                                                <span class="icon">
                                    ...
                                    <div class="tab-body__inner followers d-none " id="followers" >
                                        <div class="follower-card flex-wrap">
                                            <figure class="figure">
                                                <img src="{{asset('public/frontend_asset')}}/imgs/reviewer.png" alt="" />
                                            </figure>
                                            <div class="follower-data">
                                                <h3 class="name">
                                                    Jessica Davis
                                    ...
                                    <div class="tab-body__inner reviews d-none" id="reviews">
                                        <div class="review-item">
                                            ...
                                            <div class="row flex-equal">
                                                <h2 class="point">
                                                    4.5
                                                    <span class="small-text">out of 5</span>
                                                </h2>
                                                <div class="ratting-wrap space-0">
                                                    <ul class="ratting">
                                                        <li>
                                                ...
                                                <a href="#" class="view-btn">View Book</a>
                                            </div>
                                            <div class="review-wrap">
                                                ...
                                                <div class="review">
                                                    ...
                                                    <div class="ratting-wrap">
                                                        ...
                                                        <ul class="ratting active-ratting"
                                                            style="
                                                                  width: 70%;
                                                              ">
                                                            <li>
                                                    ...
                                                    <div class="review__media">
                                                        <div class="image">
                                                            <img src="{{asset('public/frontend_asset')}}/imgs/placeholder-12.png" alt="" />
                                                        </div>
                                                        <div class="image">
                                                            <img src="{{asset('public/frontend_asset')}}/imgs/placeholder-12.png" alt="" />
                                                        </div>
