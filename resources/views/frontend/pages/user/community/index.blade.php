            ...
            <div class="tab-content Community-tab-content">
                ...
                <div class="carousel-holder">
                  <div class="community-cards-carousel">
                    @foreach ($my_communities as $community)


                    <div class="card">
                      <a href="{{url('community/'.$community->community->id)}}" class="figure">
                        <img src="{{asset($community->community->community_cover_image)}}" alt="" />
                      </a>
                      <div class="text-wrap">
                        <a href="{{url('community/'.$community->community->id)}}" class="title">{{$community->community->community_name}}</a>
                        <h5 class="subtitle">{{get_community_member_count($community->id)}} members</h5>

                        <div class="relative flex-wrap">
                          <a href="{{url('community/'.$community->community->id)}}" class="relative__link">
                            {{-- <img src="{{asset($community->community->community_cover_image)}}" alt="" /> --}}
                          </a>
                        ...
                        <a href="{{url('community/'.$community->community->id)}}" class="card-link">View Group</a>
                      </div>
                    </div>
                    @endforeach
                  </div>
              ...
              <h2 class="heading">Explore Communities</h2>
              <p class="message">
                Welcome to SpiritBooks, your all in one marketplace for awesome
                authors and bookworms like you.
              </p>
              ...
              <div class="carousel-holder">
                <div class="community-cards-carousel">
                  ...
                  <div class="card">
                    ...
                    <div class="text-wrap">
                      <a href="#" class="title">{{$community->community_name}}</a>
                      <h5 class="subtitle">{{get_community_member_count($community->id)}} members</h5>

                      <div class="relative flex-wrap">
                        <a href="#" class="relative__link">
                      ...
                      <a href="{{url('join-community/'.$community->id)}}" class="card-link">Join Group</a>
                    </div>
                  </div>
                  @endforeach
                </div>
