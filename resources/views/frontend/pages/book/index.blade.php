                        ...
                        <div class="block-component">
                            ...
                            <div class="block-content">
                                ...
                                <div class="block-content__row buy-buttons-group">
                                    ...
                                    @else
                                        <a href="#." @disabled(true) style="background:gray">Buy in
                                            Amazon</a>
                                    @endif
                                    ...
                                    @if ($book->website_link)
                                        <a href="{{ $book->website_link }}" target="__blank" style="background:black">Buy in Website</a>
                                    @else
                                        <a href="#." @disabled(true) style="background:gray">Buy in
                                            Website</a>
                                    @endif
                                ...
                                <div class="ensure-text block-content__row">
                                    <p class="para">
                                        <span class="icon">
                                            ...
                                            <img src="{{ asset('public/assets/backend/settings/1363804363.png') }}"
                                                alt="" width="95px">
                        ...
                        <div class="tabs-wrap">
                            ...
                            <div class="tab-body">
                                ...
                                <div class="tab-body__inner media d-none" id="media">
                                    <iframe src="{{ getVideoEmbededLink($book->video_link) }}" frameborder="0"
