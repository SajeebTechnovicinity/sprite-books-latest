        ...
        <div class="inner-content">
                        ...
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                            ...
                            <defs>
                                ...
                                <div class="form-field">
                                    ...
                                    <input class="attach-input" type="file" name="file_updoad2" id="attach-file" accept="image/*" required />
                                </div>
            ...
            <div class="tab-content">
                ...
                <div class="block-wrap">
                    ...
                    <form action="{{ url('author/update-books/' . $book->id) }}" method="post" class="modal__form" enctype="multipart/form-data" style="padding-top:0; ">
                        @csrf
                        @method('post')
                        <div class="form-field">
                            <label for="isbn" class="label">ISBN*</label>
                            <input type="text" name="isbn" id="isbn" value="{{ $book->isbn }}" class="input" />
                        </div>
                        @if (session('type') == 'PUBLISHER')
                        <div class="form-field">
                            <label for="isbn" class="label">Role*</label>
                            <input type="radio" value="Publisher" name="author_define" required @if ($book->publisher_id != '') checked @endif>
                            <label for="html">Publisher</label>
                            <input type="radio" value="Author" name="author_define" required @if ($book->publisher_id == '') checked @endif>
                            <label for="html">Author</label>
                        </div>
                        ...
                        <div class="form-field">
                            ...
                            <select name="book_author" id="book_author" class="input">
                                ...
                                @foreach ($author_created_list as $listA)
                                <option value="{{ $listA->id }}" @if ($listA->id == $book->author_id && $book->publisher_id == '') selected @endif>
                                    {{ $listA->author_name }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-field">
                            <label for="title" class="label">Book Title*</label>
                            <input type="text" name="book_name" id="title" value="{{ $book->book_name }}" class="input" />
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-field">
                                <label for="links" class="label">Book Amazon Links*</label>
                                <input type="text" name="book_amazon_link" id="links" value="{{ $book->book_amazon_link }}" class="input" />
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-field">
                                <label for="links" class="label">Book Ebay Links*</label>
                                <input type="text" name="book_ebay_link" id="links" value="{{ $book->book_ebay_link }}" class="input" />
                            </div>
                            {{-- <div class="add">
                        <svg width="25" height="25" viewBox="0 0 25 25" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="form-row">
                            <div class="form-field">
                                <label class="label">Book Discount in Percentage*</label>
                                <input type="number" name="book_discount_in_percentage" value="{{ $book->book_discount_in_percentage }}" class="input" placeholder="" />
                            </div>
                        ...
                        <div class="form-row">
                            <div class="form-field">
                                <label class="label">Main Price to Show</label>
                                <input type="number" name="book_price" class="input" value="{{ $book->hard_book_price }}" placeholder="Price" />
                            </div>

                            <div class="form-field">
                                <label class="label">Book Price*</label>
                                <input type="number" name="hard_book_price" value="{{ $book->book_price }}" class="input" placeholder="HardBook" />
                            </div>
                            <div class="form-field">
                                <label class="label">Ebook Price*</label>
                                <input type="number" name="ebook_price" value="{{ $book->ebook_price }}" class="input" placeholder="Ebook" />
                            </div>
                        </div>
                            ...
                            <div class="media-item image">
                                ...
                                <a href="{{ url('delete-book-doccunment/' . $bookDocs->id) }}">
                                    <svg width="17" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                                        <path style="fill: #ffffff;" d="M432 32H312l-9.4-18.7A24 24 0 0 0 281.1 0H166.8a23.72 23.72 0 0 0-21.4 13.3L136 32H16A16 16 0 0 0 0 48v32a16 16 0 0 0 16 16h416a16 16 0 0 0 16-16V48a16 16 0 0 0-16-16zM53.2 467a48 48 0 0 0 47.9 45h245.8a48 48 0 0 0 47.9-45L416 128H32z"></path>
                                    </svg>
                                </a>
                            </div>
                            @endif
                        ...
                        <div class="form-field">
                            ...
                            <input class="attach-input" type="file" name="file_updoad" id="attach-file2" accept="image/*" />
                        </div>
                        ...
                        <div class="form-field">
                            ...
                            <input class="attach-input" type="file" name="video_file_updoad" id="attach-file3" accept="video/*" />
                        </div>
