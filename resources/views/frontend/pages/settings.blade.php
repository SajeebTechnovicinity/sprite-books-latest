...
@section('content')
    ...
    <div class="container settings">
        <h1 class="title">Add your Informations</h1>
        <form action="{{ url('save-informations') }}" method="post" class="modal__form" enctype="multipart/form-data">
            ...
            @if (session('type') == 'AUTHOR')
                <div class="form-field">
                    ...
                    <input class="attach-input" type="file" name="author_intro_video" id="attach-file2"
                        accept="video/*" />
                </div>
            @endif
            <div class="form-field">
...
@endif
            ...
            <div class="form-row">
                <div class="form-field">
                    ...
                    <input type="text" name="author_website_link" id="links"
                        value="@if ($author->author_website_link) {{ $author->author_website_link }} @endif"
                        class="input" />
                </div>
