...
<div class="container settings">
    ...
    <form action="{{ url('save-informations') }}" method="post" class="modal__form" enctype="multipart/form-data">
        ...
        <div class="form-field">
            ...
            Profile Picture (Size: 300x300)
            <input class="file" type="file" name="file_updoad" />
        </div>



        <div class="form-field">
            {{-- <label for="attach-file1" class="attach-btn btn-lite btn">
                <span class="icon">
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
...
@endif
        ...
        <div class="form-field">
            ...
            <select name="author_country" id="country" class="input">
                ...
                <option @if ($author->author_country == $list->name) @selected(true) @endif>{{ $list->name }}
                </option>
                @endforeach
            </select>
        </div>
        ...
        <div class="form-row">
            <div class="form-field">
                ...
                <input type="text" name="author_youtube_link" id="links" value="@if ($author->author_youtube_link) {{ $author->author_youtube_link }} @endif" class="input" />
            </div>
        ...
        <div class="form-row">
            <div class="form-field">
                ...
                <input type="text" name="author_facebook_link" id="links" value="@if ($author->author_facebook_link) {{ $author->author_facebook_link }} @endif" class="input" />
            </div>
        ...
        <div class="form-row">
            <div class="form-field">
                ...
                <input type="text" name="author_twitter_link" id="links" value="@if ($author->author_twitter_link) {{ $author->author_twitter_link }} @endif" class="input" />
            </div>
        ...
        <div class="form-row">
            <div class="form-field">
                ...
                <input type="text" name="author_instagram_link" id="links" value="@if ($author->author_instagram_link) {{ $author->author_instagram_link }} @endif" class="input" />
            </div>
        ...
        <div class="form-row">
            <div class="form-field">
                ...
                <input type="text" name="author_linkedin_link" id="links" value="@if ($author->author_linkedin_link) {{ $author->author_linkedin_link }} @endif" class="input" />
            </div>
        ...
        <div class="form-row">
            <div class="form-field">
                ...
                <input type="text" name="author_pinterest_link" id="links" value="@if ($author->author_pinterest_link) {{ $author->author_pinterest_link }} @endif" class="input" />
            </div>
        ...
        <div class="form-row">
            <div class="form-field">
                ...
                <input type="text" name="author_spotify_link" id="links" value="@if ($author->author_spotify_link) {{ $author->author_spotify_link }} @endif" class="input" />
            </div>
        ...
        <ul>
            ...
            <input type="checkbox" id="{{ $genre->genere_name }}" name="generes[]" value="{{ $genre->id }}" {{ in_array($genre->id, $user_generes->pluck('genere_id')->toArray()) ? 'checked' : '' }} />
