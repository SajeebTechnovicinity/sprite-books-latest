    ...
    <div class="modal__inner">
        ...
        <form action="{{ url('author/update-community/' . $community->id) }}" method="post" class="modal__form" enctype="multipart/form-data">
            ...
            <div class="form-field">
                ...
                <input type="text" name="community_name" id="title" value="{{ $community->community_name }}" class="input" />
            </div>
            ...
            <form action="{{ url('author/add-books') }}" method="post" class="modal__form" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-field">
                        ...
                        <input type="text" name="book_amazon_link" id="links" class="input" placeholder="Max 250 character" />
                    </div>
                ...
                <div class="form-row">
                    <div class="form-field">
                        ...
                        <input type="text" name="book_ebay_link" id="links" class="input" placeholder="Max 250 character" />
                    </div>
                    {{-- <div class="add">
...
<section class="body-content community-details-page">
    <div class="container">
        <div class="inner-content">
            <div class="tab-panel">
                @if (session('type') != 'USER' && check_user_max_book_by_user_id(session('author_id')) == '1')
            ...
            <div class="tab-content community_d_tab-content space-0">
                ...
                <div class="profile-banner">
                    ...
                    <div class="profile_bannere_name">Forum by {{ $community->communityAuthor->author_name }}</div>
                </div>
                <div class="community_d-info flex-wrap">
                    ...
                    <div class="more_author">
                        <img src="{{ asset('public/frontend_asset') }}/imgs/community-d-more author.png" alt="" />
                    </div>
                </div>
                            ...
                            <div class="tabs-btns-row gap">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-content" id="dropdownContent">
                                        <a href="#" class="add-btn  btn-trigger" data-target="#edit-community">Edit</a>
                                        <a href="{{ url('author/delete-community/' . $community->id) }}" onclick="confirmCancellation(event)">Delete</a>
                                    </div>
                                </div>
                                @endif
                            </div>
                            <div class="tab-body">
                                <div class="tab-body__inner d-none about" id="About">
                                    <div class="author flex gp-20">
                                        <div class="autho_img">
                                            <img height="60px" width="60px" src="@if ($community->communityAuthor->author_profile_picture) {{ asset($community->communityAuthor->author_profile_picture) }} @else {{ asset('public/frontend_asset/imgs/profile.jpg') }} @endif" alt="No Image available" />
                                        </div>
                                        ...
                                        <div class="posts flex">
                                                ...
                                                <div class="create-post_header flex">
                                                    <div>
                                                        <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            <path d="M30.2578 37.99H39.5157" stroke="#3E3E3E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                            <path d="M34.8868 22.5803C35.296 22.2087 35.851 22 36.4298 22C36.7163 22 37.0001 22.0512 37.2648 22.1508C37.5296 22.2504 37.7701 22.3963 37.9727 22.5803C38.1754 22.7642 38.3361 22.9826 38.4458 23.223C38.5554 23.4634 38.6119 23.721 38.6119 23.9812C38.6119 24.2413 38.5554 24.4989 38.4458 24.7393C38.3361 24.9797 38.1754 25.1981 37.9727 25.382L25.1146 37.0561L21 37.99L22.0287 34.2543L34.8868 22.5803Z" stroke="#3E3E3E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                        </svg>
                                                    </div>
                                                    Create Post
                                                </div>
                                                <div class="create-post_body">
                                                    <form id="add_post_form" enctype="multipart/form-data">
                                                        ...
                                                        <div class="input-area flex">
                                                            ...
                                                            <figure class="img">
                                                                <img src="@if ($current_user->author_cover_picture) {{ asset($current_user->author_cover_picture) }} @else {{ asset('public/frontend_asset') }}/imgs/profile.jpg @endif" alt="" />
                                                            </figure>


                                                            <div class="inpts">
                                                                <input class="input" placeholder="Enter your title" type="text" name="title" id="postInput" />


                                                                <textarea style="margin-top: 15px;" class="input" name="post"  rows="3" placeholder="Share what on your mind?"></textarea>

                                                                <input class="input" type="hidden" name="community_id" value="{{ $community->id }}" />
                                                            </div>
                                                        ...
                                                        <div class="cp-footer">
                                                            <label class="fpu">
                                                                <input class="input" style="display: none;" type="file" name="post_image" />
                                                                <svg width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path d="M17 1H3C1.89543 1 1 1.81297 1 2.81582V15.5266C1 16.5294 1.89543 17.3424 3 17.3424H17C18.1046 17.3424 19 16.5294 19 15.5266V2.81582C19 1.81297 18.1046 1 17 1Z" stroke="#E8922D" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                                ...
                                                                Photo/Video(Max: 5 MB) (Recommanded: 750x450 px)
                                                            </label>
                                            ...
                                            <div class="post">
                                                <div class="post__header flex-equal">
                                                    <div class="author__info flex">
                                                        <div class="author_img">
                                                            <img src="@if ($rowPost->Author->author_profile_picture) {{ asset($rowPost->Author->author_profile_picture) }} @else {{ asset('public/frontend_asset') }}/imgs/profile.jpg @endif" alt="" />
                                                        </div>
                                                        <div class="info">
                                                            <div class="name">
                                                    ...
                                                    <a href="#" class="more-option">
                                                        <svg width="37" height="37" viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <circle cx="18.5" cy="18.5" r="18.5" fill="#EDF2F6" />
                                                            <path d="M15.2857 17.0714V19.2143C15.2857 19.8058 14.8058 20.2857 14.2143 20.2857H12.0714C11.4799 20.2857 11 19.8058 11 19.2143V17.0714C11 16.4799 11.4799 16 12.0714 16H14.2143C14.8058 16 15.2857 16.4799 15.2857 17.0714ZM21 17.0714V19.2143C21 19.8058 20.5201 20.2857 19.9286 20.2857H17.7857C17.1942 20.2857 16.7143 19.8058 16.7143 19.2143V17.0714C16.7143 16.4799 17.1942 16 17.7857 16H19.9286C20.5201 16 21 16.4799 21 17.0714ZM26.7143 17.0714V19.2143C26.7143 19.8058 26.2344 20.2857 25.6429 20.2857H23.5C22.9085 20.2857 22.4286 19.8058 22.4286 19.2143V17.0714C22.4286 16.4799 22.9085 16 23.5 16H25.6429C26.2344 16 26.7143 16.4799 26.7143 17.0714Z" fill="#C0C0C0" />
                                                        </svg>
                                                    </a>
                                                </div>
                                                <div class="post__dec">
                                                        ...
                                                        <ul id="list_comment" class="col-md-12">
                                                            ...
                                                            <li class="box_result row">
                                                                <div class="avatar_comment col-md-1">
                                                                    <img src="@if ($rowComment->Author->author_cover_picture) {{ asset($rowComment->Author->author_cover_picture) }} @else {{ asset('public/frontend_asset') }}/imgs/profile.jpg @endif" alt="avatar" />
                                                                </div>
                                                ...
                                                <div class="comments_input flex">
                                                    <img src="@if ($current_user->author_cover_picture) {{ asset($current_user->author_cover_picture) }} @else {{ asset('public/frontend_asset') }}/imgs/profile.jpg @endif" alt="" />
                                                    <input type="text" placeholder="Write your comment" class="writeComment" data-id="{{ $rowPost->id }}" data-community="{{ $rowPost->community_id }}" />
                                                </div>
                                            </div>
                                            @endforeach
                                ...
                                <div class="tab-body__inner author-media d-none" id="Mycommunity">
                                    <div class="author-grid">
                                        ...
                                        <div class="grid-item author-item">
                                            <a href="{{ url('community/' . $rowCommunity->Community->id) }}">
                                                <img src="@if ($rowCommunity->Community->community_cover_image) {{ asset($rowCommunity->Community->community_cover_image) }} @else {{ asset('public/frontend_asset/imgs/profile.jpg') }} @endif" alt="" />
                                                <div class="title">
                                        ...
                                        <div class="grid-item author-item">
                                            <a href="{{ url('community/' . $rowCommunity->id) }}">
                                                <img src="@if ($rowCommunity->community_cover_image) {{ asset($rowCommunity->community_cover_image) }} @else {{ asset('public/frontend_asset/imgs/profile.jpg') }} @endif" alt="" />
                                ...
                                <div class="tab-body__inner members d-none" id="Members">
                                    <div class="grid-container">
                                        <div class="grid-items">
                                            ...
                                            <div class="grid-item author-item">
                                                <img src="@if ($rowMember->Follower->author_profile_picture) {{ asset($rowMember->Follower->author_profile_picture) }} @else {{ asset('public/frontend_asset/imgs/profile.jpg') }} @endif" alt="" />
