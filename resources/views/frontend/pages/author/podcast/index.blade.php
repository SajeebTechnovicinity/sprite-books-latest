        ...
        <div class="modal__inner">
            ...
            <form action="{{url('author/podcast')}}" method="post" class="modal__form" enctype="multipart/form-data">
                ...
                <div class="form-field">
                    ...
                    <textarea name="podcast_embed_code" class="input" placeholder="https://www.youtube.com/embed/dcicL7Nmahg?si=xI2OXI4Aqt3QZtsV"></textarea>
                </div>
                            ...
                            <div class="tabs-wrap space-0">
                                ...
                                <div class="tab-body">
                                    ...
                                    <div class="tab-body__inner" id="books">
                                        ...
                                        @endforeach
                                        <a href="#" class="add-event-btn btn-trigger" data-target="#add-podcast">Add
                                            New</a>
                                    </div>
