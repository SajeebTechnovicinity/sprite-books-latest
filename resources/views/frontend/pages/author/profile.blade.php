            ...
            <form action="{{ url('author/add-event') }}" method="post" class="modal__form"
                ...
                <div class="form-field">
                    <label for="attach-file2" class="attach-btn btn-lite btn">
                        ...
                        <span class="text">
                            Attach Image(Max 512 KB)*
                            <span class="inner">(Recommanded: 400x600 px)</span>
                        </span>
                    </label>

                    <input class="attach-input" type="file" name="image" id="attach-file2" accept="image/*"
                        required />
                </div>
                        ...
                        <div class="block-component">
                            <div class="author-summary">
                                ...
                                <ul class="social-links unit">
                                    ...
                                    @if ($author->author_twitter_link)
                                        <li>
                                            <a target="_blank" href="{{ $author->author_twitter_link }}" class="link">
                                ...
                                <div class="discribe-author unit">
                                    ...
                                    <p class="dsc">
                                        @if (strlen($author->author_description) < 100)
                            ...
                            <div class="tabs-wrap space-0">
                                <div class="tabs-btns-row">
                                    ...
                                    <a href="#podcasts" class="tab-btn">Podcast</a>
                                ...
                                <div class="tab-body">
                                        ...
                                        @if (count($author_followers))
                                            @foreach ($author_followers as $rowFollwer)
                                                <div class="follower-card flex-wrap">
                                                    <figure class="figure">
                                                        <img src="{{ asset($rowFollwer->followedAuthor->author_profile_picture ?? '') }}"
                                                            alt="" />
                                                    </figure>
                                                    <div class="follower-data">
                                                        <h3 class="name">
                                                            {{ $rowFollwer->followedAuthor->author_name ?? '' }}
                                                        </h3>
                                                        ...
                                                        <div class="follower-data__row flex-wrap">
                                                            <p class="text">
                                                                ...
                                                                </span> {{ $rowFollwer->followedAuthor->author_country }}
                                                            </p>
                                                            {{-- <p class="text">
                                                        <span class="icon">
                                    ...
                                    <div class="tab-body__inner books d-none" id="podcasts">
                                        @if (count($podcasts))
                                            <div class="podcast-grid">
                                                @foreach ($podcasts as $index => $row)
                                                    <div class="card grid-item">
                                                        {!! $row->podcast_name !!}
                                                        {!! $row->podcast_embed_code !!}
                                                    </div>
