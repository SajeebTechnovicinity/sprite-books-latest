        ...
        <div class="inner-content">
            ...
            <div class="tab-content">
                ...
                <div class="plans">
                    ...
                    @if($current_membership_plans[0]->membership_plan_id==12)
            ...
            <div id="monthly-{{ $row['membership_plan_slug'] }}" class="plan__card {{ $row->membership_plan_name }} has-price" data-monthly="{{ $row->membership_plan_monthly_price }}" data-yearly="{{ $row->membership_plan_yearly_price }}">
                <div class="inner__card flex">
                    <div class="card__heading">
                        <div class="plan-amount flex">
            ...
            @endforeach
            @foreach ($membership_plans as $row)
            <div id="yearly-{{ $row['membership_plan_slug'] }}" class="plan__card {{ $row->membership_plan_name }} has-price d-none" data-monthly="{{ $row->membership_plan_monthly_price }}" data-yearly="{{ $row->membership_plan_yearly_price }}">
                <div class="inner__card flex">
                    <div class="card__heading">
                        <div class="plan-amount flex">
                    ...
                    <button class="switch__btn current">
                        ...
                        $current_membership_plans[0]->membership_plan_monthly_price != '0' &&
                        $current_membership_plans[0]->membership_plan_yearly_price != '0')
                        <a href="{{ url('cancel-current-membership-plan') }}" onclick="confirmCancellation(event)">Cancel?</a>
                        @endif
                    </button>
                    @elseif($row->membership_plan_name == 'Free')
