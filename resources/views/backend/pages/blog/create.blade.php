                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-12">
                     ...
                     <div class="form-group col-md-12">
                        ...
                        <input type="text" name="meta_title" id="title" class="form-control" required />
                    </div>

                     <div class="form-group col-md-12">
                        <label for="title" class="label">Meta Description*</label>
                        <input type="text" name="meta_description" id="title" class="form-control" required />
                    </div>

                     <div class="form-group col-md-12">
                        <label for="title" class="label">Meta Keyword*</label>
                        <input type="text" name="meta_keyword" id="title" class="form-control" required/>
                    </div>
