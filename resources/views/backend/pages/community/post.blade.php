                            ...
                            <tr>
                                ...
                                <td>
                                    @if (isset($row->post_image))
                                        <img height="60px" width="60px" src="{{ asset($row->post_image) }}">
                                    @endif
                                </td>
                                <td>
                                    {{ $row->post }}
                                ...
                                <td>
                                    <a class="btn btn-success btn-sm"
                                        href="{{ url('admin/edit-post') }}/{{ $row->id }}">
                                        Edit
                                    </a>
                                    <a class="btn btn-danger btn-sm text-white"
                                     ...
                                     <a class="btn btn-success btn-sm"
                                        href="{{ url('admin/community/comment') }}/{{ $row->id }}">
                                        All Comment
                                    </a>
                                </td>
                            </tr>
        ...
        function confirmCancellation(event, id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "{{ url('/admin/delete-post/') }}" + "/" + id;
                }
            });
        }
    </script>
