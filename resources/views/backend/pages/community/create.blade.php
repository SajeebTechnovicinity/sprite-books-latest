    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Community Create</h4>

            </div>
            <!-- /.card-header -->
            <div class="card-body">
                <form action="{{ url('admin/store-community') }}" method="post" enctype="multipart/form-data">
                    @csrf

                    <div class="form-row">

                        <div class="form-group col-md-12">
                            <label for="dsc" class="label">Select User*</label>
                            <select class="input form-control" name="author_id">
                                @foreach ($authors as $row)
                                    <option value="{{ $row->id }}">
                                        {{ $row->author_name }} {{ $row->author_last_name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" name="community_name" id="title" value=""
                                class="form-control" />
                        </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <textarea name="community_description" class="form-control" required></textarea>
                        </div>
