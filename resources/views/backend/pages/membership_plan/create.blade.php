            ...
            <form id="add_form" enctype="multipart/form-data">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="membership_plan_slug" id="membership_plan_slug" class="form-control" />
                    </div>

                    <div class="form-group col-md-6">
                        <label for="title" class="label">Membership Plan Monthly Price*</label>
                        <input type="number" name="membership_plan_monthly_price" id="membership_plan_monthly_price" required class="form-control" />
                    </div>

                    <div class="form-group col-md-6">
                        <label for="title" class="label">Membership Plan Monthly Price Strype Key*</label>
                        <input type="text" name="membership_plan_monthly_stripe_plan" id="membership_plan_monthly_stripe_plan" required class="form-control" />
                    </div>

                    <div class="form-group col-md-6">
                        <label for="title" class="label">Membership Plan Yearly Price*</label>
                        <input type="number" name="membership_plan_yearly_price" id="membership_plan_yearly_price" required class="form-control" />
                    </div>

                    <div class="form-group col-md-6">
                        <label for="title" class="label">Membership Plan Yearly Price Strype Key*</label>
                        <input type="text" name="membership_plan_yearly_stripe_plan" id="membership_plan_yearly_stripe_plan" required class="form-control" />
                    </div>
                    ...
                    <div class="form-row" style="display: none;width: 100%;" id="publisherXtra">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="number" name="max_author_account" id="max_author_account" class="form-control" />
                        </div>

                    <div class="form-group col-md-6">
                        <label for="title" class="label">Membership Plan Author Max Book In Number*</label>
                        <input type="number" name="author_max_no_of_books" id="author_max_no_of_books" class="form-control" />
                    </div>

                    <div class="form-group col-md-6">
                        <label for="title" class="label">Membership Plan Author Max Event In Number*</label>
                        <input type="number" name="author_max_no_of_events" id="author_max_no_of_events" class="form-control" />
                    </div>
